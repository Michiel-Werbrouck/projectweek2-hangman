...
public class RechthoekTest {
    ...
    @Test
    public void equals_moet_true_teruggeven_als_verwachte_omhullende() {
        assertTrue(rechthoek.getOmhullende().getLinkerBovenhoek().equals(rechthoek.getLinkerBovenhoek())
                && rechthoek.getOmhullende().getBreedte() == rechthoek.getBreedte()
                && rechthoek.getOmhullende().getHoogte() == rechthoek.getHoogte());
    }
