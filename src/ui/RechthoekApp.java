...
public class RechthoekApp {
    ...
    public RechthoekApp(GridPane root) {
        ...
        invoerHoogte.setOnAction(eventIngaveHoogte -> {
            try {
                Punt hoekPunt = new Punt(Integer.parseInt(invoerX.getText()),Integer.parseInt(invoerY.getText()));
                vorm = new Rechthoek(hoekPunt, Integer.parseInt(invoerBreedte.getText()), Integer.parseInt(invoerHoogte.getText()));
                ...
                foutenboodschap.setContentText("Hoogte van de rechthoek moet een geheel getal zijn");
    ...
    private void init(GridPane root, int teller){
        invoerXLabel =  new Label("Geef de x-coördinaat van de linker boven hoek van de rechthoek ");
        invoerX= new TextField();

        invoerYLabel = new Label("Geef de y-coördinaat van de linker boven hoek van de rechthoek");
        ...
        invoerX.setOnAction(eventIngaveX ->{
            try {
                ...
                invoerX.clear();
                foutenboodschap.setTitle("Warning");
                foutenboodschap.setContentText("x coördinaat van het hoekpunt van de rechthoek moet een geheel getal zijn");
                foutenboodschap.showAndWait();
            }
        ...
        invoerY.setOnAction(eventIngaveY -> {
            try {
                ...
                invoerY.clear();
                foutenboodschap.setTitle("Warning");
                foutenboodschap.setContentText("y coördinaat van het hoekpunt van de rechthoek moet een geheel getal zijn");
                foutenboodschap.showAndWait();
        ...
        invoerBreedte.setOnAction(eventIngaveBreedte -> {
            try {
                ...
                invoerBreedte.clear();
                foutenboodschap.setTitle("Warning");
                foutenboodschap.setContentText("Breedte van de rechthoek moet een geheel getal zijn");
                foutenboodschap.showAndWait();
